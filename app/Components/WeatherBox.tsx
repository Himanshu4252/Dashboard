...
const WeatherBox = () => {
  ...
  return (
    <div className='h-[400px] w-full border-2 border-black flex flex-col rounded-[10px] px-2 bg-gradient-to-t from-sky-400 to-sky-100 dark:bg-gradient-to-t dark:from-[#1e293b] dark:to-[#0f172a] dark:border-[#6b7280]'>
      <div className='flex h-[80px] w-full justify-between '>
        <div className='border-r-2 border-gray-600 w-[25%] flex flex-col justify-around items-center bg-gradient-to-b from-orange-300 to-sky-100 dark:bg-gradient-to-b dark:from-[#f59e0b33] dark:to-[#3b82f633]'>
          <h3>Sunrise</h3>
        ...
        <div className=' w-[25%] flex flex-col justify-around items-center bg-gradient-to-b from-orange-300 to-sky-100 dark:bg-gradient-to-b dark:from-[#f59e0b33] dark:to-[#3b82f633]'>
          <h3>Sunset</h3>
